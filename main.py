...
# Alarm mode settings
hour_alarm = 8
minute_alarm = 0  # from 0 till 12 (output is multiplied by 5)
alarm_song_path = "songs/alarm_song.mp3"
...
button_song = pyglet.resource.media("songs/song.wav", streaming=False)
sound_win = pyglet.resource.media("songs/win.wav", streaming=False)
        ...
        try:
            ...
            if choose_selection:
                ...
                if alarm.press(palm_r_x, palm_r_y, palm_l_x, palm_l_y):
                    ...
                    if alarm_button_time == button_pause:
                        ...
                        MediaLoad = pyglet.media.load(alarm_song_path)
            ...
            if game_mode:
                ...
                if round_index != round_len:
                    ...
                    # ready, steady, go or timers for hard or easy games
                    if ready_flag:
                    ...
                    try:
                        if ready and detect(image, hour, minute, median[0], median[1], nose[0], nose[1], right_wrist[0],
                                            right_wrist[1], left_wrist[0], left_wrist[1], draw_arrow) and \
